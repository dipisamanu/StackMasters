    ...
    <div class="dashboard-container py-5">
        ...
        <div class="card card-custom mb-4">
            <div class="card-header bg-white py-3 border-bottom-0 d-flex flex-column flex-md-row align-items-center justify-content-between gap-3">
                ...
                <form method="GET" action="loans_history.php" class="d-flex gap-2 w-100 w-md-auto"
                      style="max-width: 400px;">
                    <div class="input-group">
                        <span class="input-group-text bg-light border-end-0 text-muted"><i
                                    class="fas fa-search"></i></span>
                        <input type="text" name="q" class="form-control border-start-0 bg-light"
                               placeholder="Cerca prestito..." value="<?= htmlspecialchars($search) ?>">
                        <button class="btn btn-primary px-4" type="submit">Cerca</button>
                    </div>
                    <?php if ($search): ?>
                        <a href="loans_history.php" class="btn btn-light border" title="Reset filtri"><i
            ...
            <div class="table-responsive">
                <table class="table table-hover table-custom align-middle mb-0">
                    ...
                    <?php if (empty($loans)): ?>
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">Nessun prestito trovato.</td>
                        </tr>
                    <?php else: ?>
                        <?php foreach ($loans as $l):
                            ...
                            <tr style="cursor: pointer;"
                                onclick="window.location='user_details.php?id=<?= $l['id_utente'] ?>'">
                                ...
                                <td>
                                    <a href="../../public/book.php?id=<?= $l['id_libro'] ?>"
