    ...
    try {
        ...
        // Riempiamo i buchi dei mesi mancanti se necessario, qui semplificato
        foreach ($rows as $row) {
    ...
    try {
        $stmt = $db->query("
            SELECT p.data_prestito, u.nome, u.cognome, l.titolo
            FROM prestiti p
                ...
                <div class="col-12">
                    <div class="card card-custom">
                        <div class="card-header bg-white py-3 border-bottom-0 d-flex justify-content-between align-items-center">
                            ...
                            <a href="#" class="btn btn-sm btn-light text-muted">Vedi tutti</a>
                        </div>
                                    ...
                                    <?php else: ?>
                                        <?php foreach($lastLoans as $loan): ?>
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($loan['titolo']) ?></td>
