...
<div class="container">
    ...
    <?php if ($step === '1'): ?>
        <div class="card danger-card">
            ...
            <div class="checklist">
                <div class="checklist-item <?= $prestitiAttivi === 0 ? 'ok' : 'blocked' ?>">
                    <div style="font-size: 24px;">
                        <?= $prestitiAttivi === 0 ? '<i class="fas fa-check-circle" style="color: #155724;"></i>' : '<i class="fas fa-times-circle" style="color: #721c24;"></i>' ?>
                    </div>
                    <div>
                ...
                <div class="checklist-item <?= $multe['multe_non_pagate'] === 0 ? 'ok' : 'blocked' ?>">
                    <div style="font-size: 24px;">
                        <?= $multe['multe_non_pagate'] === 0 ? '<i class="fas fa-check-circle" style="color: #155724;"></i>' : '<i class="fas fa-times-circle" style="color: #721c24;"></i>' ?>
                    </div>
                    <div>
            ...
            <div class="info-box">
                <p><strong>💡 Suggerimento:</strong> Prima di eliminare l'account, puoi esportare tutti i tuoi dati
                    personali utilizzando la funzione "Esporta Dati" dalla pagina del profilo.</p>
            </div>
